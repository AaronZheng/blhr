	...
	<body style="background-color: #E8E8E8;">
		<div class="bodybox">
			<div class="ke_tgd ke_te_tgd">
				<ul>
					<li style="background-image: url(img/xt_3.png);">
						<span>我听过的课程</span>
						<span>
			...
			<div>
				...
				<c:forEach var="cloursesInfo" items="${cloursesInfo}">
				...
				<div class="ke_back ke_backoone">
					<div class="ke_backlist">
						<div class="ke_backlist_top">
							...
							<h3><c:out value="${cloursesInfo.courseName}"></c:out>|学习时间：<c:out value="${cloursesInfo.learnTime}"></c:out></h3>
						</div>
						<div class="ke_backlist_mid">
							<c:out value="${cloursesInfo.teacherName}"></c:out>
							
						</div>
						<div class="ke_backlist_bot">
							<div class="ke_tou">
								<img src="<c:out value="${cloursesInfo.photo}"></c:out>" />
							</div>
							<div class="ke_yu">
								回放课程
							</div>
