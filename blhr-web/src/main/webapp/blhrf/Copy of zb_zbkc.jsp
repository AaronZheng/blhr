	...
	<body style="background-color: #FFFFFF;">
		<div class="bodybox">
			...
			<div class="zb_ban">
				<div class="main_visual">
					...
					<div class="main_image">
						<ul>
							<li><span class="banimg" style="background-image: url(img/baner.jpg);"></span>
							</li>
							<li><span class="banimg" style="background-image: url(img/baner.jpg);"></span>
							</li>
							<li><span class="banimg" style="background-image: url(img/baner.jpg);"></span>
			...
			<div class="xtfoot">
				<ul>
					<li>
						<a href="<%=request.getContextPath() %>/blhrf/ke_back.html">回放课程</a>
					</li>
					<li class="xt_dot">
						<a href="<%=request.getContextPath() %>/blhrf/zb_zbkc.html">直播课程</a>
					</li>
					<li>
						<a href="<%=request.getContextPath() %>/blhrf/index.html">我的学堂</a>
					</li>
				</ul>
			</div>
		</div>
