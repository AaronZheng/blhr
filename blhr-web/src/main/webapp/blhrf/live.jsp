...
<html>
	...
	<body style="background-color: #ffffff">
		<div class="bodybox">
			<div class="san_top">
				<div class="san_hred">
					<img src="<%=request.getContextPath() %>/blhrf/img/san_tou.png" />
				</div>
				<div class="san_jies">
					<h3>崔玉涛</h3>
					<div class="jie_title">中国医师协会儿童健康委员会专家</div>
					<p class="jie_content">先后工作于首都医科大学附属北京儿童医院急救中心新生儿重症监护室和中美合资北京和睦家医院儿科，主要从事新生儿急救、婴儿生长发育监测、早期婴儿问题的干预和疾病的治疗等工作，对新生儿及婴儿......
					</p>
				</div>
				<div class="san_immg">
					<img src="<%=request.getContextPath() %>/blhrf/img/san_xia.png" />
				</div>
			</div>
			<div class="san_mid">
			...
			<div class="allzbkcDiv">
						...
						<div class="ke_back">
							<div class="ke_backlist">
								...
								<div class="ke_backlist_bot">
									...
									<div class="ke_yu">
										<a href="<%=request.getContextPath() %>/blhrf/learning.html">立即学习</a>
									</div>
									<div class="ke_shu">
										345人学过
									</div>
				...
				<div class="san_zuih">
					...
					<div class="san_zuih_rght">
						<a href="<%=request.getContextPath() %>/blhrf/comment.html">
		...
		<div class="learningDiv">
			<div class="san_bot">
				<div class="ke_wodconn_top" onclick="window.location.href='playback.html'">
					<span>
				...
				<div class="san_bot_jiang">
					...
					<div class="san_youb">
						咳嗽是一种症状，不是一种疾病。对待咳嗽，首先确定引发咳嗽的原因－病毒、细菌、过敏、异物等。根据原因进行治疗咳嗽是一种症状，不是一种疾病。 咳嗽是一种症状，不是一种疾病。咳嗽是一种症状，不是一种疾病。
					</div>
				</div>
				 <div class="live_btn">
				 	<a href="<%=request.getContextPath() %>/blhrf/watching.html">立即学习</a>
				 </div>
